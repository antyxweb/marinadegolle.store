...
?>
<section id="catalog" data-entity="<?=$containerName?>">
	<?
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		?>
		<!-- items-container -->
        <div class="row justify-content-center mx-3" data-entity="items-row">
		<?
        $left = 1;
        $key = 0;
...
//
//                    $key++;
//                    if($key % 5 == 0 && $GLOBALS["APPLICATION"]->GetCurPage(false) == '/') {
//                        $left = 1;
//                    }
                    ?>
                    <div class="col-6 col-md-4 <?if($left):?>_col-border-left<?endif;?>">
                        <?
